...
*Demonstração*  
[GitHub Pages](https://raw.githubusercontent.com/LuisAntonioFreitas/estudo_alura_oracle_one_challenge_sprint03_forum_hub_java_spring/main/assets/readme/screens.gif)
</h4>
-->

<!--
![screenshot](https://raw.githubusercontent.com/LuisAntonioFreitas/estudo_alura_oracle_one_challenge_sprint03_forum_hub_java_spring/main/assets/readme/screens.gif)
-->

<p align="center">
  <img src="https://raw.githubusercontent.com/LuisAntonioFreitas/estudo_alura_oracle_one_challenge_sprint03_forum_hub_java_spring/main/assets/readme/screens.gif">
</p>

## 📋 Recursos<a id="recursos"></a>

* Backend para suporte de um fórum de Internet.

> **Nota**
>
> * Esta aplicação é uma API Backend.
> * Gerencia a criação de tópicos e respostas, com total acompanhamento, persistência e segurança.
...
Mãos à obra!
* Nesta ocasião, também disponibilizamos o diagrama do banco de dados do projeto para auxiliar você a implementá-lo. Não esqueça que você também pode usar sua criatividade e fazer as modificações que achar conveniente. Mais uma vez, usaremos o sistema de desenvolvimento ágil, utilizando o Trello da seguinte forma:
  * A coluna Pronto para começar apresenta os cartões com elementos ainda não desenvolvidos.
  * Na coluna Em Desenvolvimento estarão os elementos que você está desenvolvendo no momento. Ao iniciar uma tarefa, você poderá mover o cartão que contém essa tarefa para esta coluna.
  * Na coluna Pausado estarão os itens que você começou a desenvolver, mas precisou parar por algum motivo.
  * Por fim, na coluna Concluído estarão os elementos já concluídos.
  * O Trello é uma ferramenta que te ajudará a acompanhar o andamento de suas atividades, mas não será avaliado.
...
> * Adicionei a utilização de UUIDs em um conceito diferenciado, onde os UUIDs são utilizados apenas externamente. Pois internamente, todos os relaciomanetos são realizados através dos IDs (Long) tradicionais. 
...
> * Quanto as classes/tabelas apresentadas no diagrama, todas foram implementadas e os endpoints seguiram um padrão onde temos como buscar todos os registros ou apenas os ativos, assim como também, opção para que sejam mostrados com paginação. 
...
Faça [download](https://codeload.github.com/LuisAntonioFreitas/estudo_alura_oracle_one_challenge_sprint03_forum_hub_java_spring/zip/refs/heads/main) dos arquivos do repositório.  
E do arquivo do [diagrama](https://raw.githubusercontent.com/LuisAntonioFreitas/estudo_alura_oracle_one_challenge_sprint03_forum_hub_java_spring/main/assets/others/diagrama_banco_de_dados_forumhub.png) do banco de dados.  

[//]: # (Como também do guia em [PDF]&#40;https://raw.githubusercontent.com/LuisAntonioFreitas/estudo_alura_oracle_one_challenge_sprint03_forum_hub_java_spring/main/assets/others/guia_challenge_forumhub.pdf&#41; do desafio.)

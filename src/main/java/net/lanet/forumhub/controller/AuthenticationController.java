...
import net.lanet.forumhub.domain.authentication.AuthenticationDtoLoginRequest;
import net.lanet.forumhub.domain.authentication.AuthenticationDtoView;
...
public class AuthenticationController {
    ...
    public ResponseEntity<Object> login(@RequestBody @Valid AuthenticationDtoLoginRequest data) {
        ...
        switch (verifyClass.trim().toLowerCase()) {
            case "usuario":
                Object id = ((Usuario) authentication.getPrincipal()).getUuid();

...
import net.lanet.forumhub.domain.usuario.IUsuarioService;
...
public class ServiceCustom {
    ...
    public interface MethodsStandard<T> {
        default Optional<T> findById(String id) { return Optional.empty(); };

        default List<T> findAll(String search) { return null; };
        default List<T> findAllAtivoTrue(String search) { return null; };

        default List<T> findAll(String id, String search) { return null; };
        default List<T> findAllAtivoTrue(String id, String search) { return null; };
    }

    public static <T> T findItem(String id, MethodsStandard<T> service, Object[] item) {
    ...
    public <T, R> Boolean verifyExport(String type, String id, String search, String export,
                                       MethodsStandard<T> service, Function<T, R> viewMapper,
                                       HttpServletResponse response, Object[] item) {
        if (export != null) {
            String defineSearch = null;
